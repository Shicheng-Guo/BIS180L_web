...
```{r convert_Structure, results='hide',eval=FALSE}
...
geno.mds.pop <- left_join(geno.mds,fs_results, by="ID")
```


```{r eval=FALSE,echo=FALSE}
qplot(x=V1,y=V2,color=assignedPop, data=geno.mds.pop,geom="point",size=I(3)) + scale_color_brewer(type="div")
```
