...
diag(genes_adj85) <- 0 # important step to set edge values of genes to themselves to 0

genes_adj95 <- abs(genes_cor) > 0.95
diag(genes_adj95) <- 0 # important step to set edge values of genes to themselves to 0
```
