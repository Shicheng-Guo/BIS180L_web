...
## Change your region to Oregon

Yes, Oregon
_There is better machine availability in Oregon, so you should be able to launch an image of the proper size_
Look at the upper, right portion of your window, click on "N. California" and then select "US West (Oregon)"

## Confirm that your limits are sufficient

* Go to [limits](https://us-west-2.console.aws.amazon.com/ec2/v2/home?region=us-west-2#Limits:)
* scroll down until you get to the "t2" series.  Make sure that you a limit of at least 1 for both 
  - "t2.medium"
  - "t2.large"
- If not, please request an increase
  - In the "use case" box explain that you are enrolled in a bioinformatics class and need an instance of this size to be able to do your course.  Go ahead and give the course name, link to the webpage, and give my name as your professor.

![AWS_limit]({{ site.baseurl }}/images/AWS_limits.png)
...
1. Go to [your ec2 console](https://us-west-2.console.aws.amazon.com/ec2/v2/home?region=us-west-2)
2. Click on the blue button in the middle of the screen saying "Launch Instance"
  * It should say "Note: Your instances will launch in the US West (Oregon) region"
...
5. Select `BIS180L-02Apr18 - ami-6f325617`
...
6. On next page click on the 4th option down
  ...
  * If it won't let you click "t2.medium" then try "t2.micro"
...
1. Go to [AWS Elastic IPs](https://us-west-2.console.aws.amazon.com/ec2/v2/home?region=us-west-2#Addresses:sort=publicIp)
