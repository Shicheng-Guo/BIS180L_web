...
Keep a list of your the commands that you used in your lab_notebook.md file.  Answer the questions in the assignment2-worksheet.md file [template available on the website]({{site.baseurl}}/assignments/Assignment_2_template.md).
