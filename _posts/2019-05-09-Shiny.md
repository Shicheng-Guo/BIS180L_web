...
|:------------|:------------|:----------|:--------------------------|
| Aditya      | Chris       |           | Shiny_Aditya.Chris        |
| Alvin       | Cole        |           | Shiny_Alvin.Cole          |
| Benny       | Sankalp     |           | Shiny_Benny.Sankalp       |
| Chad        | Rebecca     |           | Shiny_Chad.Rebecca        |
| Diane       | Angus       |           | Shiny_Diane.Angus         |
| Elizabeth   | Yimei       |           | Shiny_Elizabeth.Yimei     |
| Hanna       | Bonnie      |           | Shiny_Hanna.Bonnie        |
| Hongtao     | Carine      |           | Shiny_Hongtao.Carine      |
| Jana        | Jonathan    |           | Shiny_Jana.Jonathan       |
| Jiaqi       | Tina        |           | Shiny_Jiaqi.Tina          |
| Justin      | Eric        |           | Shiny_Justin.Eric         |
| Karen       | Amber       |           | Shiny_Karen.Amber         |
| Kenzie      | Nicole      |           | Shiny_Kenzie.Nicole       |
| King        | Summer      |           | Shiny_King.Summer         |
| Krishna     | Ria         |           | Shiny_Krishna.Ria         |
| Marcus      | Picasso     |           | Shiny_Marcus.Picasso      |
| Michael     | Amanda      |           | Shiny_Michael.Amanda      |
| Raymond     | Danny       |           | Shiny_Raymond.Danny       |
| Richard     | Natasha     |           | Shiny_Richard.Natasha     |
| Samvardhini | Sina        | Surbhi    | Shiny_Samvardhini.Sina.Surbhi |
| Stevie      | Yige        |           | Shiny_Stevie.Yige         |
| Tracy       | Reema       |           | Shiny_Tracy.Reema         |
| Cameron     | Karenjit    |           | Shiny_Cameron.Karenjit    |
...
* Interactive plot to explore different hypotheses for Exercise 10 from the [R Practice lab]({{site.baseurl}}{% post_url 2019-04-18-3-R-Practice %}).
