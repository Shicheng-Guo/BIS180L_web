...
By default you may be limited to launching a very small virtual machine.  Please request an increase.
* Go to [limits](https://us-west-1.console.aws.amazon.com/ec2/v2/home?region=us-west-1#Limits:)
* scroll down until you get to the "t2" series.  Request an increase to 1 instance for both 
  - "t2.medium"
  - "t2.large"
