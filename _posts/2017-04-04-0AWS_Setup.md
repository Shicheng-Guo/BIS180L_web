...
2. In the window that pops up type the IP Address of your virtual machine followed by ":1".  The ":1" denotes screen one on your virtual machine.  For example if your virtual machine IP address was 55.53.117.125 then you would enter "52.53.117.125:1". ![EC2_TigerVNC]({{ site.baseurl }}/images/EC2_TigerVNC_IP.png)
...
1. While still in terminal type "sudu passwd ubuntu"
